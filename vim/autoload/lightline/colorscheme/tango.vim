" =============================================================================
" Filename: autoload/lightline/colorscheme/tango.vim
" Author: Jansen Price
" License: MIT License
" Last Change: 2026/02/19 20:14:00.
" =============================================================================

" This theme was adapted from 'materia'
...
if lightline#colorscheme#background() ==# 'light'
  ...
  let s:p.inactive.left   = [ [ s:bg,  s:gray4 ], [ s:bg, s:gray3 ] ]
  let s:p.inactive.middle = [ [ s:gray3, s:gray4 ] ]
  ...
  let s:gray2  = '#336600'
  let s:gray3  = '#37474f'
  let s:gray4  = [ '#999999', 8 ]

  let s:p.normal.left     = [ [ s:bg, s:green, 'bold' ], [ s:fg, s:gray2 ] ]
...
let g:lightline#colorscheme#tango#palette = lightline#colorscheme#fill(s:p)
