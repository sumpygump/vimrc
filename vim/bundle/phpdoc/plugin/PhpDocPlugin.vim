...
let g:pdv_cfg_Author = (exists("g:pdv_cfg_Author")) ? g:pdv_cfg_Author : "Name <email@address>"
...
func! PhpDocFunc()
    ...
    exe l:txtBOL . g:pdv_cfg_Comment1 . "TODO: Function description" . g:pdv_cfg_EOL
...
func! PhpDocClass()
    ...
    exe l:txtBOL . g:pdv_cfg_Comment1 . "TODO:" . l:classname . g:pdv_cfg_EOL
    exe l:txtBOL . g:pdv_cfg_Commentn . g:pdv_cfg_EOL
